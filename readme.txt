...
Tags: author, author bio, social, author box, facebook
Requires at least: 2.9
Tested up to: 3.4.1
Stable tag: 2.3
License: GPLv2

Social Author Bio automatically adds an author bio box along with Gravatar and social icons on posts. This is the most configurable author bio box!
...
*   Admin can enable/disable Social Author Bio display on Pages, Posts, and/or shortcode.
...
== Upgrade Notice ==
This version adds the ability to create your own custom Social Author Icons
